...
import { teamsTableColumns, studentsTableColumns } from "@/data/dashboard";
import { useTable } from "@/hooks/utility";
import Image from "next/image";
import { ITeamRespons, User } from "@/types/apiResponses";
...
const TeamsTable: React.FC<IProps> = ({ teams, loading }) => {
    ...
    >
      <TableContainer sx={{ maxHeight: 500, background: "#FBFAFA" }}>
        <Table stickyHeader aria-label="sticky table">
          <TableHead>
            <TableRow>
              {teamsTableColumns.map((column, index) => (
                <TableCell
                  sx={{
                    py: 2,
                  }}
