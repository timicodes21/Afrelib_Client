...
export const resources: IResources[] = [
  {
    ...
    type: "URL",
    resource: "https://www.bbc.co.uk/bitesize/topics/zf2f9j6/articles/zjk46v4",
    source: "BBC Bitesize",
  },
  {
    ...
    type: "URL",
    resource:
      "https://www.stem.org.uk/resources/elibrary/resource/254/introduction-robotics-kids",
    source: "STEM Learning",
  },
  {
    title: "Artificial Intelligence for Kids: What It Is and How It Works",
    type: "URL",
    resource: "https://kids.frontiersin.org/article/10.3389/frym.2018.00032",
    source: "Frontiers for Young Minds",
  },
  {
    title: "An Introduction to Robotics",
    type: "URL",
    resource: "https://www.dkfindout.com/uk/technology/robots/what-are-robots/",
    source: "DK Find Out",
  },
  {
    title: "Artificial Intelligence for Kids: A Beginner's Guidee",
    type: "URL",
    resource: "https://kidscodecs.com/ai-for-kids/",
    source: "Kids Codecs",
  },
  {
    title: "Understanding Artificial Intelligence: A Guide for Kids",
    type: "URL",
    resource:
      "https://medium.com/technicity/understanding-artificial-intelligence-a-guide-for-kids-85e0e4e8a09a",
    source: "Technicity",
  },
  {
    ...
    type: "URL",
    resource:
      "https://www.natgeokids.com/uk/discover/science/engineering/what-is-robotics/",
    source: "National Geographic Kids",
  },
  {
    title: "AI for Kids: An Introduction to Artificial Intelligence",
    type: "URL",
    resource:
      "https://young.scot/get-informed/national/ai-for-kids-an-introduction-to-artificial-intelligence/",
    source: "Young Scot",
  },
  {
    title: "How Robots Work: An Introduction for Kids",
    type: "URL",
    resource: "https://kids.kiddle.co/Robot",
    source: "Kiddle Encyclopedia",
  },
  {
    title: "Understanding AI: A Beginner's Guide for Kids",
    type: "URL",
    resource: "https://www.crestawards.org/2019/02/01/understanding-ai/",
    source: "CREST Awards",
  },
  {
    title: "What is a Robot? A Beginner's Guide",
    type: "URL",
    resource: "https://www.kidzworld.com/article/24981-what-is-a-robot",
    source: "Kidz World",
  },
  {
    title: "AI and Robotics: Discover the Future of Technology",
    type: "URL",
    resource:
      "https://www.ducksters.com/technology/artificial_intelligence_and_robots.php",
    source: "Ducksters",
  },
  {
    title: "An Introduction to Robotics and Programming for Kids",
    type: "URL",
    resource:
      "https://www.teachengineering.org/lessons/view/uoh_robotics_lesson01",
    source: "Teach Engineering",
  },
  {
    title: "Robotics for Kids: An Introduction to the World of Robots",
    type: "URL",
    resource:
      "https://www.stem.org.uk/resources/elibrary/resource/412211/robotics-kids-introduction-world-robots",
    source: "STEM Learning",
  },
  {
    title: "What is Artificial Intelligence? A Guide for Kids",
    type: "URL",
    resource:
      "https://www.childrensuniversity.manchester.ac.uk/media/services/thechildrensuniversityofmanchester/flash/ai/whatisai.swf",
